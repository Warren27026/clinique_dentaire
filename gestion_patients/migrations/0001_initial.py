    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('en_attente', 'En attente'), ('valide', 'Valide'), ('rejeté', 'Rejeté')], default='en_attente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_creation', models.DateTimeField(auto_now_add=True)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestion_patients.patient')),
            ],
        ),
        migrations.CreateModel(
            name='Assurance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestion_patients.dossiermedical')),
            ],
        ),
        migrations.CreateModel(
            name='RendezVous',
